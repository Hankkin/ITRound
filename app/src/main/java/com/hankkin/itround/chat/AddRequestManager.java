...
public class AddRequestManager {
  ...
  public void countUnreadRequests(final CountCallback countCallback) {
    ...
    addRequestAVQuery.whereEqualTo(AddRequest.TO_USER, UserBean.getCurrentUser());
  ...
  private void createAddRequest(UserBean toUser) throws Exception {
    UserBean curUser = UserBean.getCurrentUser();
    AVQuery<AddRequest> q = AVObject.getQuery(AddRequest.class);
  ...
  public void createAddRequestInBackground(Context ctx, final UserBean user) {
